...
enum opt_code
{
  ...
  OPT_march_ = 1171,                         /* -march= */
  OPT_masm_ = 1172,                          /* -masm= */
  OPT_mavx = 1173,                           /* -mavx */
  OPT_mavx2 = 1174,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1175,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1176,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1177,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1178,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1179,                      /* -mavx512bw */
  OPT_mavx512cd = 1180,                      /* -mavx512cd */
  OPT_mavx512dq = 1181,                      /* -mavx512dq */
  OPT_mavx512er = 1182,                      /* -mavx512er */
  OPT_mavx512f = 1183,                       /* -mavx512f */
  OPT_mavx512ifma = 1184,                    /* -mavx512ifma */
  OPT_mavx512pf = 1185,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1186,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1187,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1188,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1189,                           /* -mbmi */
  OPT_mbmi2 = 1190,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1191,                  /* -mbranch-cost= */
  OPT_mcld = 1192,                           /* -mcld */
  OPT_mclflushopt = 1193,                    /* -mclflushopt */
  OPT_mclwb = 1194,                          /* -mclwb */
  OPT_mclzero = 1195,                        /* -mclzero */
  OPT_mcmodel_ = 1196,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1197, */                    /* -mcpu= */
  OPT_mcrc32 = 1198,                         /* -mcrc32 */
  OPT_mcx16 = 1199,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1200,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1201,            /* -mdump-tune-features */
  OPT_mf16c = 1202,                          /* -mf16c */
  OPT_mfancy_math_387 = 1203,                /* -mfancy-math-387 */
  OPT_mfentry = 1204,                        /* -mfentry */
  OPT_mfma = 1205,                           /* -mfma */
  OPT_mfma4 = 1206,                          /* -mfma4 */
  OPT_mforce_drap = 1207,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1208,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1209,                       /* -mfpmath= */
  OPT_mfsgsbase = 1210,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1211, */              /* -mfused-madd */
  OPT_mfxsr = 1212,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1213,             /* -mgeneral-regs-only */
  OPT_mhard_float = 1214,                    /* -mhard-float */
  OPT_mhle = 1215,                           /* -mhle */
  OPT_miamcu = 1216,                         /* -miamcu */
  OPT_mieee_fp = 1217,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1218,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1219,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1220,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1221, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1222,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1223,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1224,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1225,                /* -mlong-double-80 */
  OPT_mlwp = 1226,                           /* -mlwp */
  OPT_mlzcnt = 1227,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1228,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1229,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1230,                  /* -mmitigate-rop */
  OPT_mmmx = 1231,                           /* -mmmx */
  OPT_mmovbe = 1232,                         /* -mmovbe */
  OPT_mmpx = 1233,                           /* -mmpx */
  OPT_mms_bitfields = 1234,                  /* -mms-bitfields */
  OPT_mmwaitx = 1235,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1236,            /* -mno-align-stringops */
  OPT_mno_default = 1237,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1238,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1239,                  /* -mno-push-args */
  OPT_mno_red_zone = 1240,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1241,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1242,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1243,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1244,                          /* -mpc32 */
  OPT_mpc64 = 1245,                          /* -mpc64 */
  OPT_mpc80 = 1246,                          /* -mpc80 */
  OPT_mpclmul = 1247,                        /* -mpclmul */
  OPT_mpcommit = 1248,                       /* -mpcommit */
  OPT_mpku = 1249,                           /* -mpku */
  OPT_mpopcnt = 1250,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1251,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1252,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1253,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1254,                        /* -mprfchw */
  OPT_mpush_args = 1255,                     /* -mpush-args */
  OPT_mrdpid = 1256,                         /* -mrdpid */
  OPT_mrdrnd = 1257,                         /* -mrdrnd */
  OPT_mrdseed = 1258,                        /* -mrdseed */
  OPT_mrecip = 1259,                         /* -mrecip */
  OPT_mrecip_ = 1260,                        /* -mrecip= */
  OPT_mrecord_mcount = 1261,                 /* -mrecord-mcount */
  OPT_mred_zone = 1262,                      /* -mred-zone */
  OPT_mregparm_ = 1263,                      /* -mregparm= */
  OPT_mrtd = 1264,                           /* -mrtd */
  OPT_mrtm = 1265,                           /* -mrtm */
  OPT_msahf = 1266,                          /* -msahf */
  OPT_msgx = 1267,                           /* -msgx */
  OPT_msha = 1268,                           /* -msha */
  ...
  OPT_mstv = 1286,                           /* -mstv */
  OPT_mtbm = 1287,                           /* -mtbm */
  OPT_mtls_dialect_ = 1288,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1289,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1290,                    /* -mtune-ctrl= */
  ...
  OPT_quiet = 1330,                          /* -quiet */
  OPT_r = 1331,                              /* -r */
  OPT_remap = 1332,                          /* -remap */
  OPT_s = 1333,                              /* -s */
  OPT_save_temps = 1334,                     /* -save-temps */
  OPT_save_temps_ = 1335,                    /* -save-temps= */
  OPT_shared = 1336,                         /* -shared */
  OPT_shared_libgcc = 1337,                  /* -shared-libgcc */
  /* OPT_specs = 1338, */                    /* -specs */
  OPT_specs_ = 1339,                         /* -specs= */
  OPT_static = 1340,                         /* -static */
  OPT_static_libasan = 1341,                 /* -static-libasan */
  OPT_static_libgcc = 1342,                  /* -static-libgcc */
  OPT_static_libgfortran = 1343,             /* -static-libgfortran */
  OPT_static_libgo = 1344,                   /* -static-libgo */
  OPT_static_liblsan = 1345,                 /* -static-liblsan */
  OPT_static_libmpx = 1346,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1347,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1348,               /* -static-libstdc++ */
  OPT_static_libtsan = 1349,                 /* -static-libtsan */
  OPT_static_libubsan = 1350,                /* -static-libubsan */
  /* OPT_std_c__03 = 1351, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1352, */                /* -std=c++0x */
  OPT_std_c__11 = 1353,                      /* -std=c++11 */
  OPT_std_c__14 = 1354,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1355, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1356, */                /* -std=c++1y */
  OPT_std_c__1z = 1357,                      /* -std=c++1z */
  OPT_std_c__98 = 1358,                      /* -std=c++98 */
  OPT_std_c11 = 1359,                        /* -std=c11 */
  /* OPT_std_c1x = 1360, */                  /* -std=c1x */
  /* OPT_std_c89 = 1361, */                  /* -std=c89 */
  OPT_std_c90 = 1362,                        /* -std=c90 */
  OPT_std_c99 = 1363,                        /* -std=c99 */
  /* OPT_std_c9x = 1364, */                  /* -std=c9x */
  OPT_std_f2003 = 1365,                      /* -std=f2003 */
  OPT_std_f2008 = 1366,                      /* -std=f2008 */
  OPT_std_f2008ts = 1367,                    /* -std=f2008ts */
  OPT_std_f95 = 1368,                        /* -std=f95 */
  OPT_std_gnu = 1369,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1370, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1371, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1372,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1373,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1374, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1375, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1376,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1377,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1378,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1379, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1380, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1381,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1382,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1383, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1384, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1385,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1386, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1387, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1388, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1389,                     /* -std=legacy */
  OPT_symbolic = 1390,                       /* -symbolic */
  OPT_t = 1391,                              /* -t */
  OPT_time = 1392,                           /* -time */
  OPT_time_ = 1393,                          /* -time= */
  OPT_traditional = 1394,                    /* -traditional */
  OPT_traditional_cpp = 1395,                /* -traditional-cpp */
  OPT_trigraphs = 1396,                      /* -trigraphs */
  OPT_u = 1397,                              /* -u */
  OPT_undef = 1398,                          /* -undef */
  OPT_v = 1399,                              /* -v */
  OPT_version = 1400,                        /* -version */
  OPT_w = 1401,                              /* -w */
  OPT_wrapper = 1402,                        /* -wrapper */
  OPT_x = 1403,                              /* -x */
  OPT_z = 1404,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
